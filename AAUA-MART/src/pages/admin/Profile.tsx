      ...
      <IonContent className="bg-gray-50">
        <div className="p-4">
          <div className="flex flex-col items-center py-8">
            ...
            <IonBadge color="danger" className="mt-2">Administrator</IonBadge>
          </div>

          <IonCard className="mb-4">
            <IonCardContent className="p-0">
              <IonItem lines="inset">
                <IonIcon icon={personOutline} slot="start" color="danger" />
                <IonLabel>
          ...
          <IonCard className="mb-6">
            <IonCardContent>
              <div className="flex items-center gap-3">
                <IonIcon icon={shieldCheckmarkOutline} color="danger" style={{ fontSize: 24 }} />
                <div>
                  <p className="text-xs text-gray-400">Admin since</p>
